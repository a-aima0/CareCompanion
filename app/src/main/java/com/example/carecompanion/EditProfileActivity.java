...
//                }
//
//                // Check if user is signed in with Google or another federated provider
...
//
//                if (isGoogleSignIn) {
//                    // Update the profile information directly if the user is signed in with Google
...
//        privateUpdates.put("email", profileEditEmail.getText().toString());
...
//                if (!profileEditEmail.getText().toString().equals(user.getEmail())) {
//                    // Verify email change if email is updated
//                    user.verifyBeforeUpdateEmail(profileEditEmail.getText().toString()).addOnSuccessListener(new OnSuccessListener<Void>() {
//                        @Override
