...
//                }
//
//                Log.d("DEBUG", "onComplete: cCode: " + cCode.getText().toString());
//                Log.d("DEBUG", "onComplete: phoneNumber: " + phoneNumber.getText().toString());
//
//                if (FirebaseAuth.getInstance().getCurrentUser() != null) {
//                    //user is authenticated, proceed wih Firestore operations
//                    // Check if user exists in Firestore
//                    db.collection("users")
//                            .whereEqualTo("ccode", cCode.getText().toString()) // Check ccode
//                            .whereEqualTo("phone", phoneNumber.getText().toString()) // Check phone number
//                            .get()
//                            .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
//                                @Override
//                                public void onComplete(@NonNull Task<QuerySnapshot> task) {
...
//
//                                            verifyPhoneNumber(userPhoneNumber);
//                                            Toast.makeText(getApplicationContext(), "Sending OTP to " + "+" + cCode + " " + userPhoneNumber, Toast.LENGTH_SHORT).show();
//                                            Log.d(TAG, "onComplete: sending OTP");
//                                        } else {
//                                            // User does not exist or combination of ccode and phone not found
//                                            Toast.makeText(getApplicationContext(), "User does not exist or invalid combination of country code and phone number.", Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(getApplicationContext(), "User is not authenticated. Please Login", Toast.LENGTH_SHORT).show();
//                    Log.d(TAG, "onClick: User is not authenticated. Redirected to login screen");
//                    startActivity(new Intent(getApplicationContext(), LoginActivity.class));
//                    finish();
//                }
//            }
...
//                PhoneAuthCredential credential = PhoneAuthProvider.getCredential(verificationID, inputOTP.getText().toString());
//
//                // authenticate the user only if they exist in firestore
//                authenticateUser(credential);
//            }
//        });
//
...
//            @Override
//            public void onSuccess(AuthResult authResult) {
//                // Proceed to main activity for existing users
//                startActivity(new Intent(getApplicationContext(), MainActivity.class));
//                finish();
//            }
//        }).addOnFailureListener(new OnFailureListener() {
